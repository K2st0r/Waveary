...
test("deriveGettingToKnowYouState does not mistake call me scheduling follow-ups for a user name", () => {
  const state = deriveGettingToKnowYouState(
    createRequest({
      user: {
        id: "user-1",
      ...
      messages: [
        ...
        },
        {
          ...
          sessionId: "session-1",
          role: "user",
          content: "Call me tomorrow when you can.",
          timestamp: new Date().toISOString(),
          metadata: {}
        }
      ],
...
test("deriveGettingToKnowYouState does not mistake call me sequencing follow-ups for a user name", () => {
  const state = deriveGettingToKnowYouState(
    createRequest({
      user: {
        id: "user-1",
      ...
      messages: [
        ...
        },
        {
          ...
          sessionId: "session-1",
          role: "user",
          content: "Call me after work if you want.",
          timestamp: new Date().toISOString(),
          metadata: {}
        }
      ],
...
test("deriveGettingToKnowYouState does not mistake light status updates for a user name", () => {
  const state = deriveGettingToKnowYouState(
    createRequest({
      user: {
        id: "user-1",
...
test("deriveGettingToKnowYouState does not mistake transit or wake-up updates for a user name", () => {
  const state = deriveGettingToKnowYouState(
    createRequest({
      user: {
        id: "user-1",
