...
1. Start the first `waveary-voice` delivery path.
   ...
   Next cut: choose the next voice implementation step now that routing diagnostics and shell states are browser-verified end-to-end: provider-backed STT, or a truer realtime duplex / interruption pass.
