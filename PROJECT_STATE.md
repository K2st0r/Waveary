...
- `c997f41` - `Broaden low-stakes chat cadence detection`
...
- continue the dialogue-quality pass by extending the new low-stakes short-texting cadence beyond status updates and tiny confirmations into the next bounded everyday-message buckets such as softer `okay then`, `好喔`, `行呀`, or lightly hedged micro-updates, while keeping emotional-first handling and identity inference narrow
